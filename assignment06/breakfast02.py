...
async def main():
    ...
    cooking_tasks = [asyncio.create_task(FryEggs(2)), asyncio.create_task(FryBacon()), asyncio.create_task(ToastBread(2))]
    _, _ = await asyncio.wait(cooking_tasks, return_when=asyncio.ALL_COMPLETED)
